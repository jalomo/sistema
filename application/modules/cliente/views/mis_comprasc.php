  ...
  <div class="row show-grid">
    ...
    <!-- AQUI ES DONDE VA HA ESTAR EL CONTENIDO -->
    	<!--div class="margen50" align="center" >
           	...
           	<a href="<?php echo base_url().'/index.php/cliente/mis_alojamiento'?>" title="Alojamiento">
            ...
            <a href="<?php echo base_url().'/index.php/cliente/mis_trasporte'?>" title="trasporte">
            <div class="menu_botones color_blanco btn btn-default">
            <br/>
            ...
            <a href="<?php echo base_url().'/index.php/cliente/mis_eventos'?>" title="eventos">
            <div class="menu_botones color_blanco btn btn-default">
            <br/>
        ...
        <div class="panel panel-primary margen50">
          <div class="panel-heading" align="center">Mis compras</div>
              ...
              <ul class="list-group">
                ...
                <?php foreach($user_eventos as $evento => $campo):?>
                 ...
                 <li class="list-group-item">
                  <span class="badge"><a href="#" style="color:#fff;">Itinerario</a></span>
                  
                   <span class="badge"><a href="#" style="color:#fff;">Imprimir boleto</a></span>
                    <span class="badge"><a href="<?php echo base_url();?>/index.php/cliente/view_evento_compra/<?php echo $campo["euId"];?>/<?php echo $campo["eventoId"];?>" style="color:#fff;">ver</a></span>
                     <span class="badge">status</span>
                   <?php echo $this->clientes->get_name_evento($campo["eventoId"]);?>
                 </li>
