	...
	<div class="contenido_p" >
    	<div class="conten- float-left">
            ...
            <div class="menu-cotenido- " id="servicios_">
             <div align="center" style=" font-weight:bold; font-size:18px;">MIS COMPRAS</div>
            
           		
           	<a href="<?php echo base_url().'/index.php/cliente/mis_alojamiento'?>" title="alojamiento">
            <div class="fondo_servicios float-left" style="width:200px; height:250px; margin-left:50px; margin-top:10px;">
            <br/>
            <br/>
