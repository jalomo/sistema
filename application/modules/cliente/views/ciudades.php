	...
	<div class="contenido_p" >
    	<div class="conten- float-left">
           ...
           <?php foreach($ciudades as $ciudad):?>		
           	<a href="<?php echo base_url().'/index.php/cliente/alojamiento/'.$ciudad->ciudadId?>"><div class=" float-left" style=" font-size:20px;width:200px; height:100px; margin-left:50px; margin-top:10px; background: rgba(255, 255, 255, 0.5); border-radius: 25px;">
            	
                
                
                <div class="color-azul font-nexa-bold" style=" margin-top:20px;"><?php echo $ciudad->ciudadNombre;?></div>
