...
<div class="container-fluid show-top-margin separate-rows tall-rows tamano1500 fondo_pantalla">
  ...
  <div class="row show-grid">
    ...
    <!-- AQUI ES DONDE VA HA ESTAR EL CONTENIDO -->
    	<div class="color_blanco" align="center" >
        	
            
            <div class="panel panel-info margen50">
          <div class="panel-heading" align="center">SELECCIONA UN RP</div>
              ...
              <?php if($rps!=0):?>
                <?php foreach($rps as $rp):?>
                 ...
                 <li class="list-group-item">
                  <span class="badge"><input type="radio" name="save[rp]"/></span>
                   <?php echo $rp->adminNombre;?>
                 </li>
