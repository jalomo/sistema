...
<!--script type="text/javascript" src="<?php echo base_url();?>statics/bootstrap/js/modal.js"></script-->
...
$(".muestra_image").click(function(){
       url_image= $(this).attr("im");
        imagen="<div align='center'><img src='"+url_image+"' /></div>";
       $(".container-modal").html(imagen);
...
<div class="container-fluid show-top-margin separate-rows tall-rows tamano1500 fondo_pantalla">
  ...
  <div class="row show-grid">
   ...
   .fondo_h_c{ background:#2980b9; color:#fff; height:30px;}
    ...
    <div>
     <div class="alojamiento_imagen color_blanco  " style="float:left"  >
    
            <br/>
            <div align="center">
           <?php echo img(array('src'=>$casa->casaImage,'width'=>'280px')); ?>
           </div>
            <br/>
            <hr/>
            <div align="center">
      ...
      <div class="alojamiento_mod color_blanco  "  style="float:left" >
                ...
                <?php 
                      ...
                      if(is_array($casaCuartos)){
							...
							$cuartosDiv.='<div class="cuartos_casas" id=cuarto-'.$idcu.'>
                                         ...
                                         <div><p><a href="'.$base."/index.php/cliente/pay_cuarto/".$idcu.'">Reservar</a></p></div>
                                      </div>  
                                    <div class="mod-line">
                            ...
                            <div class="cuartos_casas" id="cuarto-<?php echo $idcu;?>">
                                           ...
                                           <div class="test"><p><?php echo $desc;?></p></div>
                                        
											
                                          <div class="cuartoscasas">
                                          <div><a href="#" im="<?php echo $base.$imagen;?>" class="muestra_image">Imagen</a></div>
                                           
										   
                                           <div>$<?php echo $precio;?></div>
                                           <div><p ><a class="ser-cuartos" href="#" casa="<?php echo $idca;?>" cuarto="<?php echo $idcu;?>">Servicios</a></p></div>
                                         <div><p><a href="<?php echo $base."/index.php/cliente/pay_cuarto/".$idcu;?>">Reservar</a></p></div>
                                      </div>  
                                    <div class="mod-line">
