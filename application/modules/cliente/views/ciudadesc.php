...
<div class="container-fluid show-top-margin separate-rows tall-rows tamano1500 fondo_pantalla">
  ...
  <div class="row show-grid">
   ...
   <style>
   .textos_al{ font-size:20px;color:#2980b9;}
   </style>
    
    <!-- AQUI ES DONDE VA HA ESTAR EL CONTENIDO -->
    <div align="center" class="textos_al">Housing</div>
    
     <?php if($ciudades!=0):?>
           <?php foreach($ciudades as $ciudad):?>		
           	<a href="<?php echo base_url().'/index.php/cliente/alojamiento/'.$ciudad->ciudadId?>" class="texto_menu_casa btn btn-default casas_cuadro"><?php echo $ciudad->ciudadNombre;?>
