	...
	<div class="contenido_p" >
    	<div class="conten-  fondo_registro float-left">
            ...
            <div class="menu-cotenido-" id="" align="justify">
             ...
             <div id="datos_"></div>
             <?php echo form_open('cliente/editar_user/'.$usuario->usuarioId, array('id'=>'save_user1')); ?>
    ...
    <div id="successMessage" style="color:#060; display: none">Evento guardado correctamente</div>
    	<table width="500" border="0" >
          ...
          <tr>
            ...
            <td><input type="text"  style="width:300px; height:30px;" name="user[usuarioNombre]" id="usuarioNombre" readonly class="texto_login" value="<?php echo $usuario->usuarioNombre;?>"/></td>
             <td align="right"><span style="font-size:18px;color:#808080"> Sexo:</span></td>
            <td> 
            <?php if(($usuario->usuarioSexo!="")){?>
            <?php echo $usuario->usuarioSexo;?>
            <?php }else{?>
            <select style="width:300px; height:30px;" name="user[usuarioSexo]" class="texto_login">
          ...
          <tr>
            ...
            <td> 
            <?php if(($usuario->usuarioTelefonno!="")){?>
            <?php echo $usuario->usuarioTelefonno;?>
            <?php }else{?>
            <input type="text" style="width:300px; height:30px;" name="user[usuarioTelefonno]" id="usuarioTelefonno"  class="texto_login"/>
             <?php }?>
            </td>
         ...
         <td align="right"><span style="font-size:18px;color:#808080"> Ciudad:</span></td>
          <td>
           <?php if($usuario->usuarioIdCiudad!=0){?>
            <?php echo $usuario->usuarioIdCiudad;?>
            <?php }else{?>
