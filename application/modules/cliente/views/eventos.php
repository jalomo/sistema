...
<div class="contenido_" align="center">
	<div class="contenido_p" >
    	<div class="conten- float-left">
            ...
            <br/>
            <div class="menu-cotenido-  " id="servicios_" style="background: rgba(255, 255, 255, 0.5); border-radius: 25px;">
             ...
             <br/>
            <div align="left" class="color-azul font-nexa-bold" style=" font-size: 20pt;color:#636363; height:700px;overflow:scroll;">
            ...
            <?php if($eventos!=0):?>   
                ...
                <a href="<?php echo base_url().'/index.php/cliente/view_evento/'.$evento->eventoId?>">
