	...
	<div class="contenido_p" >
    	<div class="conten- float-left">
           ...
           <?php foreach($casas as $casa):?>		
           	<a href="<?php echo base_url().'/index.php/cliente/casa/'.$casa->casaId?>"><div class="fondo_servicios float-left" style="width:200px; height:250px; margin-left:50px; margin-top:10px;">
            	<?php echo img(array('src'=>$casa->casaImage,'width'=>'170px')); ?>
                <div class="color-azul font-nexa-bold"><?php echo $casa->casaNombre;?></div>
