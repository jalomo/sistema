	...
	<div class="contenido_p" >
    	<div class="conten- float-left">
            ...
            <div class="menu-cotenido-  fondo_registro" id="servicios_">
             <div align="center" style=" font-weight:bold; font-size:18px;">Pago modificadores</div>
            
           
             
             
             <?php echo form_open('cliente/savePagoModExtras', array('id'=>'save_user')); ?>
           <table width="600" border="0">
           
          <?php $index=0; $total=0; for($index=0;$index<count($modificadores);$index++):?>
              <tr>
                 <td colspan="4"><?php $aux =$modificadores[$index]["precio"]; settype($aux, "integer"); $total+=$aux;  echo($modificadores[$index]["nombre"]. " ".$modificadores[$index]["precio"]);?></td>
                 <input type="hidden"   name="modificadores[]"   value="<?php echo($modificadores[$index]['idu']."-".$modificadores[$index]['ide']."-".$modificadores[$index]['idr']."-".$modificadores[$index]['idm']."-".$modificadores[$index]['nombre']."-".$modificadores[$index]['precio'])?>">
