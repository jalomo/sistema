   ...
   .eventos_con{ height:765px;
    ...
    <div class="eventos_con" align="center">
            ...
            <?php if($eventos!=0):?>   
                ...
                <a href="<?php echo base_url().'/index.php/cliente/evento_tipo/'.$evento->eventoId?>">
                <input type="image"  src="<?php echo base_url().$evento->eventoUrlImage;?>"  type="submit"  width="750px" height="200px;">
                </a>
