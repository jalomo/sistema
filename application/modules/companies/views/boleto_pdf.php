    ...
    <div id="wrapper-boleto">
        <div id="header_boleto">
          ...
          <div id="wrapper-codigo">
             <div><?php echo "<img id='img-codigo'  src='codigoBarras_img.php?numero=".$codigo."'/>";?></div>
             <div><p id="p-evento"><?php echo($dataEvento[0]["eventoNombre"])?></p></div>
          ...
          <div id="wrapper-evento">
             ...
             <div id="e-precio"><p>$<?php echo($costo)?></p></div>
          </div>
