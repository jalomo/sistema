...
/* Otros estilos */ 
background:#333333; height:50px; width:195px; margin-top:10px; position:absolute; display: block; bottom: 0px; top: 85px;
font-size:18px;
cursor:pointer;
} 
.contenedorr2 { 
...
/* Otros estilos */ 
background:#8c8c8c; height:50px; width:195px; margin-top:10px; position:absolute; display: block; bottom: 0px; top: 137px;
font-size:18px;
cursor:pointer;
}    
.contenedorr1 { 
...
<table width="100%" height="100%" border="0" style="height:100%; display:table; position:absolute;">
  <tr height="100%">
    ...
    <div style="background:#FFF; position:absolute; display: block; bottom: 0px; top: 20px; height:50px; width:900px;" class="font-helvetica">
   ...
   <?php echo anchor('companies/get_data_evento/', '', array('id'=>'get_id', 'style'=>'display: none')); ?>
    ...
    <div id="load_proyectos" align="center" style=" position:absolute; display: block; bottom: 0px; top: 70px; height:200px; width:900px;">
