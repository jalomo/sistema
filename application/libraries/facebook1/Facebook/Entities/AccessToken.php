...
require_once(  APPPATH . 'libraries/facebook/Facebook/Exceptions/FacebookResponseException.php' );
require_once( APPPATH . 'libraries/facebook/Facebook/Exceptions/FacebookSDKException.php' );
require_once( APPPATH . 'libraries/facebook/Facebook/FacebookClient.php' );
require_once( APPPATH . 'libraries/facebook/Facebook/GraphNodes/GraphSessionInfo.php' );
