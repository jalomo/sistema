...
require_once(  APPPATH . '/libraries/facebook/Facebook/Entities/FacebookApp.php' );
require_once(  APPPATH . '/libraries/facebook/Facebook/Entities/AccessToken.php' );
require_once(  APPPATH . '/libraries/facebook/Facebook/Entities/FacebookRequest.php' );
require_once(  APPPATH . '/libraries/facebook/Facebook/Entities/FacebookBatchRequest.php' );
require_once(  APPPATH . '/libraries/facebook/Facebook/Entities/FacebookResponse.php' );
require_once(  APPPATH . '/libraries/facebook/Facebook/Entities/FacebookBatchResponse.php' );
require_once(  APPPATH . '/libraries/facebook/Facebook/HttpClients/FacebookHttpClientInterface.php' );
...
require_once(  APPPATH . '/libraries/facebook/Facebook/HttpClients/FacebookGuzzleHttpClient.php' );
